  ...
  return (
    <Layout>
      ...
      <ImageText
        ...
        text="With Internago’s payroll portal, you have the perfect tool to manage your international employees in one single interface. It’s simple to use and gives your company the possibility to use the same system for your domestic and international employees when registering absence, vacations and other deviations. All is done directly on the portal. By handling everything in the same place your management and HR will have a clear calendar overview of all absences which significantly improves personnel planning."
        image={calendartime}
        alt="Calendar and hourglass icon"
        active="notactive"
      />
      <ImageText
        ...
        text="Sick of handling excel sheets and emails with expense reports? Our built-in expense management tool standardises this work for all your employees and on all your international markets. Using a simple online access, it provides a quick overview of all your expenses. With a smooth and easy registration process, as well as a rapid and easy handling and approval of errands, your previous time is saved, and your company’s internal efficiency is increased."
        image={expense}
        alt="Window tab that handles expenses"
        active="notactive"
      />
      <ImageText
        ...
        width="short"
        title="ShareDoc"
        text="Don't remember where you stored that employment contract? With Share documents you will have all your sensitive and important documents in one place. You can share the documents directly with your colleagues or external collaborators through hyperlinks accessible only by permitted personnel. Additionally, this tool allows you to access all files in one place, which means you spend less time searching for information and more time focussing on your job. We support all types of files like PDF, Word, JPEG etc. and our log feature makes it transparent who has added, deleted, or made any changes to files. "
        image={mobile}
        alt="Phone icon"
        active="notactive"
      />
      <ImageText
        ...
        width="short"
        title="Multilingual"
        text="Having foreign workers also means handling multiple languages. Our portal comes with the option of language adaptation. This means that it can be easily updated to allow for the integration of languages or other related adjustments in accordance with your organisation’s needs."
        image={speech}
        alt="Balloon bubble icon"
        active="notactive"
      />
      <ImageText
        ...
        text="Many organisations have multiple approving managers and several different roles. A local director that may handle the absence management for his or her employees, but it is the responsibility of central HR to manage payroll and absences of that local director. As all our customers have their specific requirements, we have created an advanced configuration tool to handle your organisation’s specific needs and payroll workflow. This will eliminate the risk of error and make your payroll workflow more efficient and secure."
        image={stamp}
        alt="Approving document icon"
        active="notactive"
      />
